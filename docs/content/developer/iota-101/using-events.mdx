...
[`client.queryEvents`](../../developer/ts-sdk/typescript/api/client/classes/IotaClient#queryevents).
...
The [TypeScript SDK](../../developer/ts-sdk/typescript/api/graphql/classes/IotaGraphQLClient) provides functionality to
...
See [Rust SDK](../../developer/iota-sdk/getting-started/rust.mdx).
