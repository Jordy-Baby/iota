...
The IOTA SDKs for [TypeScript](../../../../developer/ts-sdk/typescript/index.mdx) and [Rust](../../../../developer/iota-sdk/getting-started/rust.mdx) handle coin management automatically,
